...
export const postData: AllPostData[] = [
    ...
    {
        id: 18,
        title: "광주 쪽 갈 것 같은데 추천 좀 해주세요!",
        content: "광주 쪽 갈 것 같은데 갈 만한 곳 있을까요? 근처에 갈 만한 곳이나 볼거리 있으면 추천 좀 해주세요! 맛집도 부탁드려요 ㅎㅎ 감사합니다.",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 45,
        category: "광주",
        author: {
    ...
    {
        id: 19,
        title: "제주도 현지 맛집 있을까요? ",
        content: "제주도 현지 맛집 추천 좀 해주세요! 제주도 가서 맛있는 음식 먹고 싶어요. 현지인들이 자주 가는 맛집 있으면 추천 부탁드립니다! 감사합니다.",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 31,
        category: "제주도",
        author: {
    ...
    {
        id: 26,
        title: "겨울에 사진 찍기 좋은 장소 추천해주세요!",
        content: "이번 겨울에 한국을 여행하면서 멋진 사진을 찍고 싶어요. 눈이 내리면 예쁜 장소나 분위기 좋은 카페, 혹은 특별한 곳들 추천 부탁드려요!",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 33,
        category: "자유",
        author: {
    ...
    {
        id: 27,
        title: "서울에서 꼭 먹어봐야 할 길거리 음식?",
        content: "이번 주말에 서울에 갈 건데, 꼭 먹어봐야 할 길거리 음식이 뭐가 있을까요? 떡볶이랑 호떡은 들어봤는데, 다른 추천 메뉴도 알려주세요!",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 42,
        category: "자유",
        author: {
    ...
    {
        id: 30,
        title: "서울 근처 온천 추천해주세요!",
        content: "날씨가 너무 추워서 온천에 가고 싶어요. 서울 근처에 괜찮은 찜질방이나 자연 온천 추천 부탁드려요. 몸 좀 녹이고 싶어요!",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 37,
        category: "자유",
        author: {
    ...
    {
        id: 35,
        title: "한국에서 사가기 좋은 간식 추천",
        content: "한국을 떠나기 전에 친구들에게 줄 만한 간식을 사고 싶어요. 가방에 넣기 간편하면서도 특별한 간식 추천 부탁드려요!",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 50,
        category: "자유",
        author: {
    ...
    {
        id: 37,
        title: "겨울에 가기 좋은 국내 여행지?",
        content: "한국에서 겨울에 가기 좋은 여행지 추천 부탁드려요. 눈 구경하면서 힐링할 수 있는 조용한 장소면 좋겠어요.",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 45,
        category: "자유",
        author: {
    ...
    {
        id: 38,
        title: "서울의 야경 즐길 수 있는 핫플!",
        content: "서울에서 야경이 멋진 곳을 찾고 있어요. 꼭 남산타워가 아니더라도 덜 알려진 곳 있으면 추천해주세요. 조용히 즐길 수 있는 곳이면 더 좋아요!",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 39,
        category: "자유",
        author: {
    ...
    {
        id: 39,
        title: "겨울 낭만 즐기기 좋은 축제 추천!",
        content: "겨울에 열리는 축제 중에 분위기 좋은 곳 있을까요? 특히 크리스마스 느낌 나는 곳이면 좋겠어요. 가족과 함께 갈 수 있는 곳도 추천해주세요.",
        photoUrl: "https://picsum.photos/1100/200",
        likes: 52,
        category: "자유",
        author: {
